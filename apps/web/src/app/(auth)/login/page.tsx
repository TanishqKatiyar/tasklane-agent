...
function LoginForm() {
  ...
  return (
    <>
      {/* Section eyebrow */}
      <div
        className="flex items-center gap-3 p-edge-tag"
        aria-hidden={false}
      >
      ...
      <div className="space-y-3">
        ...
        <p
          ...
          style={{ color: "var(--p-ink-soft)" }}
        >
          Pick up where you left off. Tasks, drafts, and team — all exactly how
          you left them.
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div
          className="flex items-center justify-center gap-2 p-edge-tag opacity-70"
          aria-hidden
        >
