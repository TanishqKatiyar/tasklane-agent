  ...
  return (
    <div className="paper p-grain relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(rgb(28 15 9 / 0.08) 1px, transparent 1px)",
      ...
      <div className="relative z-10 grid min-h-screen lg:grid-cols-[1.1fr_1fr]">
        ...
        <div className="relative hidden flex-col justify-between overflow-hidden px-10 py-10 lg:flex xl:px-14">
          ...
          <div className="relative z-10 max-w-[640px]">
            ...
            >
              Tasklane is a calm, opinionated workspace for teams who treat
              shipping as a craft. No bloat, no AI-generated noise — just the
              tools that disappear into the rhythm of your day.
            </p>
            ...
            <figure className="relative mt-10 max-w-[500px] animate-rise-4">
              ...
              <blockquote
                ...
                style={{ color: "var(--p-ink)" }}
              >
                We replaced four tools with Tasklane and somehow our weeks got
                quieter. That&apos;s the part nobody markets.
              </blockquote>
              <figcaption
        ...
        <div className="relative flex items-center justify-center px-6 py-12 lg:px-14">
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 60px 140px -50px rgb(28 15 9 / 0.45), inset 0 0 0 1px var(--p-rule)",
              }}
            />
            <div
          ...
          <div className="absolute left-6 top-6 flex items-center gap-3 lg:hidden">
            ...
            <span className="p-display text-[20px] tracking-tight">
              Tasklane
            </span>
          </div>
