    ...
    <div className="min-h-full overflow-y-auto p-8">
      ...
      <div className="mt-10 max-w-3xl space-y-8">
        ...
        <div className="space-y-4">
          <h2 className="font-display p-display border-b border-[var(--p-rule)] pb-2 text-[24px] leading-tight tracking-tight">Profile</h2>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  You have used <strong className="text-foreground">14</strong> of <strong className="text-foreground">100</strong> AI requests this hour.
                </p>
                <div className="mt-4 h-1.5 w-full overflow-hidden rounded-full bg-[var(--p-rule)]">
                  <div className="h-full rounded-full bg-[var(--p-accent)] transition-all" style={{ width: "14%" }} />
                </div>
              </div>
            ...
            {showDeleteConfirm && (
              <div className="rounded-lg border border-red-500/30 bg-card p-4 space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Type <strong className="text-foreground">DELETE</strong> below to confirm account deletion.
                </p>
                <input
                  type="text"
                  value={deleteInput}
