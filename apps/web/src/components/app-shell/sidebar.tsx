...
function TasklaneLogo({ collapsed }: { collapsed: boolean }) {
  return (
    ...
    >
      ...
      {!collapsed && <span className="text-sm font-semibold tracking-tight">Tasklane</span>}
    </Link>
  );
}
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="flex-1 truncate text-left text-sm font-medium">{active.name}</span>
...
function NavItem({ href, icon: Icon, label, collapsed, badge, children }: NavItemProps) {
...
function SidebarContent({
  ...
  return (
    <>
      ...
      >
        <NavItem href="/inbox" icon={Inbox} label="Inbox" collapsed={collapsed} badge={3} />
        <NavItem href="/my-tasks" icon={CheckSquare} label="My Tasks" collapsed={collapsed} />
        <NavItem href="/projects" icon={FolderKanban} label="Projects" collapsed={collapsed} />
        {currentTeamId && (
          <NavItem
        ...
        <NavItem href="/activity" icon={Activity} label="Activity" collapsed={collapsed} />
        <NavItem href="/standup" icon={Sparkles} label="AI Standup" collapsed={collapsed} />
        <NavItem href="/settings" icon={Settings} label="Settings" collapsed={collapsed} />
        <NavItem href="/changelog" icon={FileText} label="Changelog" collapsed={collapsed} />
      </nav>
