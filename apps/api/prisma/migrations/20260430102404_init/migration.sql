...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('TASK_CREATED', 'TASK_UPDATED', 'TASK_STATUS_CHANGED', 'TASK_ASSIGNED', 'TASK_COMMENTED', 'PROJECT_CREATED', 'MEMBER_INVITED', 'MEMBER_REMOVED', 'ROLE_CHANGED');
...
CREATE TABLE "LabelOnTask" (
    ...
    CONSTRAINT "LabelOnTask_pkey" PRIMARY KEY ("taskId","labelId")
);
